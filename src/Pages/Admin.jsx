                        ...
                        <div className=' w-full xl:w-[79.3vw]'>
                            <div className='w-[100%] bg-[#005B61]  flex justify-between text-white font-[poppins]'>
                                <div className='flex w-[40%] justify-between px-[2.2%] py-[0.8vw]'>
                                    <div className='flex flex-col'>
                                        <span className='text-[1.5vw] font-[700]'>
                                           Okunade Sherif Damilare
                                        </span>
                                        <span className='flex items-center justify-between text-[0.9vw] font-[400] mt-[0.6vw]'>
                                    ...
                                    <div className='font-[poppins] flex flex-col justify-between '>
                                        <span className='text-[1.1vw] font-[600]'>User ID</span>
                                        <span className='text-[0.9vw] font-[400]'>
                                            0091282732
                                        </span>
                                    </div>
                                </div>
                                <div className='text-white w-[25%] flex justify-between items-center mr-[2vw] text-[1.7vw]'>
                                    <Divider
                                        type='vertical'
                            ...
                            <div className='flex justify-between items-center bg-white  px-[2.2%] py-[0.8vw]'>
                                <div className='w-[70%] flex justify-between'>
                                    <div className='flex flex-col '>
                                        <span className='text-[#282828] font-[500] text-[1.2vw]'>
                                            Password
                                        </span>
                                        <span className='mt-[0.5vw] text-[#575757] text-[0.9vw] font-[400]'>
                                            adeleksiju!@#
                                        </span>
                                    </div>
                                    <div className='flex flex-col '>
                                ...
                                <button className='underline text-[#005B61] font-[600] text-[1.2vw]'>
                                    View Profile
                                </button>
                            </div>
                            {/* GRAPHS */}
                            <div className='mt-[30px] md:mt-[40px] xl:mt-[1vw] flex flex-col lg:flex-row justify-between w-full'>
                                <div
                                    ...
                                    <div className='w-full customerdbtablediv mt-[1.5vw]'>
                                        <Table
                                            columns={columns}
                                            className='w-full'
                                            dataSource={
