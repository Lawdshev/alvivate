        ...
        },
        {
            ...
            render: (text) => (
                <>
                    ...
                    {text === "abandoned" && (
                        <div className='flex text-[#D8B70E] font-poppins text-[5px] md:text-[9px] lg:text-[12px] xl::text-[12px] font-normal'>
                            {" "}
                            <span>{text}</span>
                        </div>
                    )}
                    ...
                    <main className='bg-[#F5F5F5] w-[100vw] md:w-[90vw] flex flex-col min-h-[88vh] 2xl:min-h-[90vh] px-[2.8vw] pt-[1.7vw]'>
                        <div className=' w-full xl:w-[79.3vw]'>
                            <div className='w-[100%] bg-[#005B61]  flex justify-between text-white font-[poppins]'>
                                ...
                                <div className='text-white w-[25%] flex justify-between items-center mr-[2vw] text-[8px] md:text-[12px] lg:text-[14px] xl:text-[1.7vw]'>
                                    <Divider
                                        type='vertical'
                            ...
                            <div className='flex justify-between items-center bg-white p-[10px] md:p-[16px]  xl:px-[2.2%] xl:py-[0.8vw]'>
                                <div className='w-[80%] md:w-[70%] flex justify-between'>
                                    <div className='flex flex-col '>
                                        <span className='text-[#282828] font-[500] text-[7px] md:text-[12px] lg:text-[14px] xl:text-[1.2vw]'>
                                            Password
                                        </span>
                                        <span className='mt-[0.5vw] text-[#575757] text-[5px] md:text-[9px] lg:text-[12px] xl::text-[0.9vw] font-[400]'>
                                            adeleksiju!@#
                                        </span>
                                    </div>
                                    <div className='flex flex-col '>
                                ...
                                <button className='underline text-[#005B61] font-[600] text-[7px] md:text-[12px] lg:text-[14px] xl:text-[1.2vw]'>
                                    View Profile
                                </button>
                            </div>
                            {/* GRAPHS */}
                            <div className='mt-[30px] md:mt-[40px] xl:mt-[1vw] flex flex-col lg:flex-row justify-between w-full'>
                                <div
                                    id='table'
                                    className='w-[100%] overflow-x-scroll md:overflow-x-hidden md:w-full lg:w-[75%] bg-[#ffffff] py-[16px] px-[24px] xl:py-[1vw] xl:px-[2vw] flex flex-col'>
                                ...
                                <div className='w-[100%] bg-[#ffffff] md:mx-0 mt-[16px] lg:mt-0 lg:w-[23%] p-[1%]'>
