...
function Women() {
  ...
  return (<>
      <div className="text-white flex flex-col items-center justify-around py-14 bg-cover h-full" style={{backgroundColor:'#120241',minHeight:'60vh',backgroundImage:"url('https://www.pixelstalk.net/wp-content/uploads/2016/06/Fashion-Wallpaper-High-Resolution-For-Desktop.jpg')"}}>
